				...
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="studentRegSub" action="">
						<div class="form-group">
							 <label for="studentName" class="col-sm-2 control-label">真实姓名</label>
							<div class="col-sm-10">
								<input class="form-control" name="studentName" id="studentName" type="text" placeholder="真实姓名" />
							</div>
						</div>
						<div class="form-group">
							 <label for="studentPwd" class="col-sm-2 control-label">考试登录账户</label>
							<div class="col-sm-10">
								<input class="form-control" name="studentAccount" id="studentAccount" type="text" placeholder="考试登录账户" />
							</div>
						</div>
						<div class="form-group">
							 <label for="studentPwd" class="col-sm-2 control-label">考试登录密码</label>
							<div class="col-sm-10">
								<input class="form-control" name="studentPwd" id="studentPwd" type="password" placeholder="考试登录密码" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								 <button type="button" onclick="stuReg()" class="btn btn-default btn-lg btn-primary btn-block" id="signSubmit">
							 		注  册
								 </button>
							</div>
						</div>
