		...
		<div style="width: 60%; height: 100%; float: left;">
			<div style="width: 100%; height: 80%;">
				<dl subject="1" style="width:100%;">
					<span style="display: none;" id="exam-studentId">${student.studentId }</span>
		...
		<div style="width: 38%; float: right;margin-top: -61px;">
			<div style="width:100%; height:63px;text-align: center;">
				...
				<div style="float: right; width: 55%;height: 100%;line-height: 63px; text-align: left;">
					<a href="${path}/student/submit.action?studentId=${student.studentId }&examPaperId=${examPaperId }&classId=${classId }&gradeId=${gradeId }" type="button" class="btn btn-default btn-sm" onclick="return confirm('确定提交吗?')">提交</a>
