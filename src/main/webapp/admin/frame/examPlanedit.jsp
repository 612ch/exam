				...
				<form class="form-horizontal" role="form" id="examPlanAction" action="examPlan" method="post">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-4">
							<c:if test="${examPlan.examPlanId == null }">
								<button id="sub" type="button" class="btn btn-default btn-lg btn-block" onclick="onSubmit(2,'/examPlanInfo/addExamPlanInfo.action','#examPlanAction')">
									提交
								</button>
							</c:if>
							<c:if test="${examPlan.examPlanId != null }">
								<button id="sub" type="button" class="btn btn-default btn-lg btn-block" onclick="onSubmit(1,'/examPlanInfo/updateExamPlanInfo.action','#examPlanAction')">
									提交
								</button>
							</c:if>
						</div>
