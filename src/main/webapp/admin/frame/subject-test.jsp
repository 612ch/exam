		...
		<div id="editor-content" class="tab-content">
			...
			<div class="container" style="margin-top:10px;">
							...
							<div class="col-md-6 column" style="margin-top:5px;">
								<div class="form-group">
									...
									<div class="col-sm-5" style="padding-left: 8px;">
										<select class="selectpicker" name="gradeId" id="gradeId"
												data-live-search="true">
											<c:if test="${subject != null }">
				...
				<c:if test="${subject != null }">
					...
					<button id="sub2" onclick="onSubmit(1,'/subject/subjectUpdate.action','#radio-form')"
							type="button" style="width: 180px;height: 50px;position: absolute;left: 800px" class="btn btn-default btn-lg btn-block">
						提交</button>
				</c:if>

				<c:if test="${subject == null }">
							<button id="sub2" onclick="onSubmit(2,'/subject/addSubject.action','#radio-form')"
										type="button" style="width: 180px;height: 50px;position: absolute;left: 800px" class="btn btn-default btn-lg btn-block">
										提交</button>
				</c:if>
			</div>
