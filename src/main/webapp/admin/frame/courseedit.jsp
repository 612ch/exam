                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" id="courseId" name="courseId" type="text"
                                   value="${course.courseId }" readonly="readonly" unselectable='on'
                                   onfocus='this.blur()'/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" id="courseName" name="courseName" type="text"
                                   value="${course.courseName}" placeholder="学科名称"/>
                        </div>
                    </div>
            </div>
            <br/>
                ...
                <div class="col-sm-offset-2 col-sm-4">
                    <c:if test="${course.courseId == null }">
                        <button id="sub" type="button" class="btn btn-default btn-lg btn-block"
                                onclick="onSubmit(2,'/course/courseadd.action','#courseAction')">
                            提交
                        </button>
                    </c:if>
                    ...
                    <c:if test="${course.courseId != null }">
                        <button id="sub" type="button" class="btn btn-default btn-lg btn-block"
                                onclick="onSubmit(1,'/course/updateCourseInfo.action','#courseAction')">
                            提交
                        </button>
                    </c:if>
                </div>
