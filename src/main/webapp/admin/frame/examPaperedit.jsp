					...
					<form class="form-horizontal" role="form" id="examPaperAction" action="examPaper" method="post">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								...
								<c:if test="${examPaper != null }">
									<button id="sub" type="button" class="btn btn-default btn-lg btn-block" onclick="onSubmit(1,'/examPaper/update.action','#examPaperAction')">
										修改
									</button>
								</c:if>
								<c:if test="${examPaper == null }">
									<button id="sub" type="button" class="btn btn-default btn-lg btn-block" onclick="onSubmit(1,'/examPaper/add.action','#examPaperAction')">
										添加
									</button>
								</c:if>
							</div>
